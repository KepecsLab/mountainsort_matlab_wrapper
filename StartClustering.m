% wrapper script to convert recording files to mda files
...
GeomPath = '';% optional path to geom.csv file defining probe layout
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%this prepares mountainview function for in-matlab call (execute only
%after soring)
...
for session = 1:length(Animals)
    ...
    TrodeConfigFile = strcat(aConvert2MClustnimal,'Config.mat');
